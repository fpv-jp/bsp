...
motor_arm1.location = (0.0, 0.0, 34)
...
#motor_arm2 = create_motor_arm()
#motor_arm2.rotation_euler = (math.pi / 8, 0, math.pi)
#motor_arm3 = create_motor_arm()
#motor_arm3.rotation_euler = (math.pi / 8, 0, math.pi / 2)
#motor_arm4 = create_motor_arm()
#motor_arm4.rotation_euler = (math.pi / 8, 0, -math.pi / 2)

#### --- 腕・モータを複製 ---
##arm2 = base.copy(arm, rotation=)
##arm3 = base.copy(arm2, rotation=)
##arm4 = base.copy(arm2, rotation=)
