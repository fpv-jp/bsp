...
```bash
sudo apt install -y libsoup-3.0-dev libjson-glib-dev libnice-dev
sudo apt install -y libgstreamer1.0-dev libgstreamer-plugins-bad1.0-dev
sudo apt install -y gstreamer1.0-libcamera
sudo apt install -y gstreamer1.0-tools gstreamer1.0-plugins-base-apps gstreamer1.0-plugins-bad gstreamer1.0-nice gstreamer1.0-alsa
